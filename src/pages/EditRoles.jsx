...
function RoleEdit() {
    ...
    const loadRole = async () => {
        try {
            ...
            // build empty permission structure
            ...
            // mark allowed permissions true
            role?.permissions?.forEach(p => {
                if (initialPermissions[p.module]) {
                    p.actions.forEach(action => {
                        if (initialPermissions[p.module][action] !== undefined) {
                            initialPermissions[p.module][action] = true;
                        }
                    });
                }
            });
    ...
    const handleSubmit = async (e, modeFromButton) => {
        e.preventDefault();
        ...
        try {
            ...
            const finalStatus = modeFromButton || (formData.isActive ? 'active' : 'inactive');
