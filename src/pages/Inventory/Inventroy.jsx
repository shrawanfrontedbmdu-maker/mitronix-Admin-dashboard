      ...
      >
        ...
        >
          ...
          >
            ...
            <div
              style={{ fontSize: "28px", fontWeight: "600", color: "#ef4444" }}
            >
                ...
                <tbody>
                  {products.map((p, index) => {
                    ...
                    const isLowStock =
                      !hasVariants &&
                      (p.stockQuantity || 0) <=
                        (p.lowStockThreshold || lowThreshold);
                    const isOutOfStock =
                      !hasVariants && (p.stockQuantity || 0) === 0;
                    ...
                    return (
                      <React.Fragment key={p._id || p.slug || index}>
                        ...
                        {hasVariants &&
                          isExpanded &&
                          p.variants.map((variant, vIndex) => {
                            const vIsLowStock =
                              (variant.stockQuantity || 0) <= lowThreshold;
                            const vIsOutOfStock =
...
{selectedVariant && (
  <div style={{
    ...
    <div style={{ marginBottom: "16px" }}>
      ...
      <input
        type="number"
        value={selectedVariant.reservedQty || 0}
        onChange={(e) =>
          setSelectedVariant({
            ...selectedVariant,
    ...
    <div style={{ marginBottom: "16px" }}>
      ...
      <input
        type="number"
        value={selectedVariant.leadTimeDays || 0}
        onChange={(e) =>
          setSelectedVariant({
            ...selectedVariant,
    ...
    <div style={{ marginBottom: "16px" }}>
      ...
      <select
        multiple
        value={selectedVariant.fulfillmentOptions || []}
        onChange={(e) =>
          setSelectedVariant({
            ...selectedVariant,
            fulfillmentOptions: Array.from(
    ...
    <div style={{ display: "flex", gap: "10px" }}>
      <button
        onClick={async () => {
          await instance.post("/store-inventory/inventory", {
            productId: selectedProductId,
            variantSku: selectedVariant.sku,
            stockQty: selectedVariant.stockQuantity,
            reservedQty: selectedVariant.reservedQty,
            leadTimeDays: selectedVariant.leadTimeDays,
            fulfillmentOptions: selectedVariant.fulfillmentOptions,
          },{
            headers:{
